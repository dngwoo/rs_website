...
import AboutPatent from './AboutPatent';
import AboutPatentImg from './AboutPatentImg';
...
export default class About extends Component {
  state = {
    ...
    patent: [
      ...
      {
        explanation:
          '멀티 웨어러블 센서 기반의 싱크로나이제이션 체크를 통한 골프 스윙자세 교정 디바이스 및 시스템, 그리고 이의 제어 방법',
